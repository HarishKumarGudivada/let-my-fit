...
<body ng-app=""  style="font-family: Helvetica;font-size: 14px" >
...
<center><h2 style="color:'#c00'">Add Best Fittings For Your Match</h2></center>
			...
			<tr>
				<td>
					<table>
						...
						<tr>
							<td colspan="2" align="right"><input type="submit" value="Submit" style="font-family: Helvetica;font-size: 12px;height: 25px;color: 'cyan';background-color: #c00"/></td>
						</tr>
					</table>
				</td>
	...
	<img src="resources/images/kurthiMeasurments.jpg">
